...
| - Auth : 회원가입, 로그인, 휴대폰인증, 마이페이지<br> | - 블록체인 로직 이식 | - 추모관 : 파일 업로드, 즐겨찾기, 검색, 리스트 |
| - Main : 메인 화면 및 배너, 하단 네비게이션<br> | - 추모관 무한스크롤 퍼블리싱 | - 유언 생성 : 녹음, 재생, 열람인, 증인, 선택사항 |
|
| [React]<br> | [Block Chain] | [React] |
| [Figma UI/UX 디자인]<br> | - 스마트 컨트랙트 배포 | - 증인 유언장 열람 신청, 열람인 유언장 열람 신청, 유언장 |
| [UCC 제작] | - FE - Block Chain 이식 | |
|  | - IPFS : 설정 / 노드 구성 | 
