...
public class SmsCertificationUtil {
    ...
    public SingleMessageSentResponse sendWillLink(String to, String deadName, String viewerName, String willCode) {
        String applyLink = "http://j10c208.p.ssafy.io/viewer";
