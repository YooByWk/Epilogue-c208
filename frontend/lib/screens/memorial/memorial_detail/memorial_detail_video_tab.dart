          ...
          return NotificationListener<ScrollNotification>(
              ...
              child: Container(
                ...
                child: ListView.builder(
                  itemCount: viewModel.videos
                      .length, // 수정: itemCount를 viewModel.videos.length로 설정합니다.
...
class _VideoCardState extends State<VideoCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return VisibilityDetector(
      ...
      onVisibilityChanged: (visibilityInfo) {
        debugPrint('비디오 ${widget.index} 가 ${visibilityInfo.visibleFraction * 100} % 보여짐');
  ...
  debugPrint('Video is playing: ${videoPlayerController.value.isPlaying}');
});
      },
