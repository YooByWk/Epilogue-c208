  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: Scaffold(
          ...
          body: Consumer2<UserViewModel, MyWillViewModel>(builder: (context, viewModel, myWillViewModel, child) {
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20),
                      CommonButtonWidget(text: 'text', onPressed: () => debugPrint(myWillViewModel.graveType.toString())),
                      CommonButtonWidget(
                          height: 200,
                          width: 200,
